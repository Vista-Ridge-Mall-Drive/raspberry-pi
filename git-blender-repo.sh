...
sudo apt-get install -y libopenvdb-dev libblosc-dev libspnav-dev alembic python-alembic python3-alembic 
sudo apt-get install -y llvm-7-dev libopencolorio-dev libvpx5 libopenimageio-dev python3-numpy libopenexr-dev 
